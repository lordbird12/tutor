...
export class EditComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        this.formData = this._formBuilder.group({
            ...
            higth: [0, Validators.required],
            weight: [0, Validators.required],
            fatMass: [0, Validators.required],
            muscle: [0, Validators.required],
    ...
    ngOnInit(): void {
        ...
        this._Service.getById(this.id).subscribe((resp: any) => {
            ...
            this.formData.patchValue({
                ...
                avatarSex: this.itemData.avatarSex,
                higth: this.itemData.higth,
                weight: this.itemData.weight,
                fatMass: this.itemData.fatMass,
                muscle: this.itemData.muscle,
                visceralMass: this.itemData.visceralMass,
                bmi: this.itemData.bmi,
                taget: this.itemData.taget,
                handness: this.itemData.handness,
                str: this.itemData.str,
                vit: this.itemData.vit,
                int: this.itemData.int,
                agi: this.itemData.agi,
                dex: this.itemData.dex,
                level: this.itemData.level,
